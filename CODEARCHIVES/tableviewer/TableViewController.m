...
//    userArray = [[NSMutableArray alloc] initWithObjects:@"Bob", @"Alex",
//                 @"Alligator", @"Mundo", nil];
    NSDictionary *personOne = @{@"name" : @"Bob",
                                @"pet" : @"Dog"};
    NSDictionary *personTwo = @{@"name" : @"Alex",
                                @"pet" : @"Cat"};
    NSDictionary *personThree = @{@"name" : @"Alligator",
                                @"pet" : @"Croc"};
    NSDictionary *personFour = @{@"name" : @"Mundo",
                                @"pet" : @"GOESWHEREHEPLEASES"};
    userArray = [[NSMutableArray alloc] initWithObjects:personOne, personTwo,
                 personThree, personFour, nil];
